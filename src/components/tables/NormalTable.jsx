							...
							{columns.map((column, colIndex) => {
								if (colIndex === 0) {
												...
												>
													<div className='flex items-center gap-2'>
														...
														<div className='flex items-center'>
															...
															<div className='ps-3'>
																<div className='text-neutral-700'>{row[column.accessor].name}</div>
																<div className='font-normal	text-xs'>{row[column.accessor].desc}</div>
															</div>
														</div>
													</div>
												</td>
									...
									switch (column.Header) {
										...
										default:
											return (
												<td key={column.accessor} className='py-[18px] px-[22px] text-left border-b border-gray-200'>
													{row[column.accessor]}
												</td>
											);
									}
